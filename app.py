...
from streamlit import button, title
...
with st.sidebar:
    option=option_menu("Main Menu",options=["Home","ML Risk Predictor","About"],icons=[" "," "," "])
...
if option=="Home":
...
elif option=="ML Risk Predictor":

    st.title("ML Accident Risk Score Predictor")
    st.markdown(" ")
    st.markdown(" ")
    ##ML
    st.sidebar.title("⚠️ Accident Risk Filters")
    ...
    contri_df_og=contri_df[contri_df["contribution"]>0]
    #st.dataframe(contri_df_og)
    ...
    st.subheader("Accident Risk Score")
    ...
    st.sidebar.markdown("### Accident Risk Prediction:")
    st.sidebar.markdown(
        f"""
    ...
    fig10=px.bar(contri_df_og,x="coulmn",y="contribution",color="coulmn")
    st.subheader("Risk Contribution Factors")
    ...
    st.sidebar.markdown("### 🛡 Top Contributing Factors:")
    ...
    if abt=="Dataset":
        ...
        with col2:
            st.metric("⚠ Fatal Accidents", len(df[df["accident_severity"] == "fatal"]))
        with col3:
        ...
        The **Road Accident Analysis Dashboard** is an interactive data visualization platform designed to analyze road accident patterns across India. It transforms raw accident data into meaningful insights through dynamic charts, filters, and key performance indicators, enabling users to identify accident trends, high-risk locations, and contributing factors.

        Built using **Python** and **Streamlit**, the dashboard provides an intuitive interface for exploring accident data based on various parameters such as state, city, weather conditions, road type, accident severity, and time.

        ---

        ## 🎯 Project Objectives

        - Analyze road accident data efficiently.
        - Identify accident-prone states and cities.
        - Understand the impact of weather, road conditions, and time on accidents.
        - Visualize accident trends using interactive charts.
        - Support data-driven road safety awareness and decision-making.
        ...
        - 📉 Trend Analysis
        - 📌 State-wise and City-wise Insights
        ...
        - **Dataset:** Indian Road Accident Dataset (Kaggle)
        ...
        - Total and Fatal Accident Statistics
        ...
        **Shriyans Mohanty**
        ...
        This dashboard was developed during a **Data Analytics Training Program conducted by O7 Services, Jalandhar**. It demonstrates practical skills in data preprocessing, exploratory data analysis, interactive visualization, and dashboard development using Streamlit.
        ...
        - AI-powered Risk Score Generation
        - Geographic Heatmaps
        ...
        Thank you for exploring the **Road Accident Analysis Dashboard**.

        Every visualization in this dashboard is designed to make accident data easier to understand and promote data-driven decision-making for improving road safety.
        """)
